    ...
    public partial class SeedProduct : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.UpdateData(
                ...
                keyColumn: "id",
                keyValue: 2L,
                columns: new[] { "CategoryName", "Description", "ImageUrl", "Name" },
                values: new object[] { "T-shirt", "It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.<br/>The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English.<br/>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default Model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy.", "https://github.com/leandrocgsi/erudio-microservices-dotnet6/blob/main/ShoppingImages/2_no_internet.jpg?raw=true", "Camiseta No Internet" });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 2L,
                columns: new[] { "CategoryName", "Description", "ImageUrl", "Name" },
                values: new object[] { "T-Shirt", "Uma caneca para você beber seu café", "https://images.tcdn.com.br/img/img_prod/1066831/caneca_bumbum_grandao_escolha_a_cor_da_caneca_nao_e_magica_3145_1_67375d7557d970ab318292cb6952799c.jpg", "Name" });
        }
    }
}
